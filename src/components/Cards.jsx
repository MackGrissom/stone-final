...
import KitchenPhoto from '/src/assets/KitchensCard.jpg'
import BathroomPhoto from '/src/assets/BathroomCard.jpg'
import OtherPhoto from '/src/assets/OtherPhoto.jpg'
...
const Cards = () => (
  <div className="card-container mb-20 flex justify-evenly border-[red] ">
    <Card
      hoverable
