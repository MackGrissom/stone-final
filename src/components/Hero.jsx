...
const Hero = () => {
    return (
        ...
        <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12  hero relative mb-10 hero">

            <img src={Logo} className='w-[40%] hero-logo animate_animated ' />
            ...
            <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-[#D2B48C] md:text-5xl lg:text-6xl ">
            <Typed
        ...
        />
            ...
            <a href="https://precision_stoneworks.quotekitchenandbath.com/kitchen#/materials/countertops/countertop" class="inline-flex justify-between items-center py-1 px-1 pr-4 mb-7 text-sm text-gray-700 bg-gray-100 rounded-full dark:bg-gray-800 dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700" role="alert">
